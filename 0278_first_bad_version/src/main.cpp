...
{
  ASSERT_EQ(Solution::firstBadVersion(5, [](int n)
                                      { return n >= 4; }),
            4);
}
...
{
  ASSERT_EQ(Solution::firstBadVersion(1, [](int n)
                                      { return n >= 1; }),
            1);
}
...
{
  ASSERT_EQ(Solution::firstBadVersion(2, [](int n)
                                      { return n >= 2; }),
            2);
}
...
{
  ASSERT_EQ(Solution::firstBadVersion(2126753390, [](int n)
                                      { return n >= 1702766719; }),
            1702766719);
}
